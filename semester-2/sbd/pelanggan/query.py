...
def fetch_customer_by_id(customer_id):
    ...
    try:
        ...
        print(f"\n[Database Error]: Gagal mengecek ID pelanggan. {e}")
        return False
    finally:
        cursor.close()
...
def fetch_all_customers():
    ...
    try:
        ...
        print(f"\n[Database Error]: Gagal mengambil semua data pelanggan. {e}")
        return []
    finally:
        cursor.close()
...
def fetch_customer_order_details(customer_id):
    ...
    try:
        ...
        print(f"\n[Database Error]: Gagal memuat detail pesanan pelanggan. {e}")
        return []
    finally:
        cursor.close()
...
def insert_customer(name, address, phone):
    ...
    try:
        ...
        db.rollback()
        print(f"\n[Database Error]: Gagal menambah pelanggan baru. {e}")
        return False
    finally:
        cursor.close()
...
def update_customer(customer_id, name, address, phone):
    ...
    try:
        ...
        db.rollback()
        print(f"\n[Database Error]: Gagal memperbarui data pelanggan. {e}")
        return False
    finally:
        cursor.close()
